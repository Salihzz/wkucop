...
<img class="logo" src="images/ddr.png" align="left"  style="width:7%" >
 <img class="logo" src="images/abc.png" align="right"  style="width:10%">
  <div class="title">  
    <h2> جامعة غرب كردفان <br>كلية علوم الحاسوب وتقانة المعلومات
      <br>
      <p class="subtitle"> منصة كلية علوم الحاسوب وتقانة المعلومات </p></h2>
	   
  </div>
</section> 
 <div class="container" style="min-height: 500px;">  
      <center><p class="page-header" style="font-size: 30px;">Register</p></center>
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="center">&copy; All Rights Reseved</p>
     </footer>
 </section>
